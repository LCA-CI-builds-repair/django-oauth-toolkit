import pytest
from django.contrib.auth import get_userimport pytest
...
class TestOidcViews(TestCase):
    ...
    # Define other test methods here with necessary corrections
...
class TestJwksInfoView(TestCase):
    def test_get_jwks_info(self):
        ...
        self.assertEqual(response.status_code, 200)
        assert response.json() == expected_responsemport reverse
