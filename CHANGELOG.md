...
and this project adheres to # CHANGELOG

## [Unreleased]
- Add new feature for XYZ
- Fix issue with ABC functionality

## [1.0.0] - 2022-01-01
- Initial releaseSemantic Versioning](https://semver.org/spec/v2.0.0.html).
